...
export function SolutionsHero() {
  return (
    <section id="solutions" className="solutions-hero-section" aria-label="Solutions Hero">
      {/* Fresha-Style Large Rounded Hero Ambient Glow Backdrop */}
      <div className="hero-fresha-glow-wrapper" aria-hidden="true">
        <div className="fresha-glow-pill" />
        <div className="fresha-glow-orb-left" />
        <div className="fresha-glow-orb-right" />
      </div>
      ...
      <div className="solutions-hero-container">
        ...
        <div className="solutions-hero-grid">
          <p data-reveal="" className="solutions-hero-desc">
            Mobile, web, custom software, AI, enterprise systems and cloud. Every
            engagement is delivered by the team that builds and runs nine live
            products on the same shared core.
          </p>
